...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      {/* Servicios Section - Agregada para habilitar el enlace del Header */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-left">
            <div className="p-6 border rounded-xl">
              ...
              <h3 className="font-bold mb-2">Centralización Documental</h3>
            ...
            <div className="p-6 border rounded-xl">
              <CheckCircle2 className="w-6 h-6 text-syntix-green mb-2" />
              <h3 className="font-bold mb-2">Reportes de Estado</h3>
